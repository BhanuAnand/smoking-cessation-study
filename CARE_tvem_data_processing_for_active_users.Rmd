...
```{r}
care_data <- read_csv("O:/QMP-BIDS/Utah - CARE Datasets/Aditi/CARE/Code/Survival-HMM-Care/care_ema_raw/curated_random_ema_care_data_for_active_users.csv")
```
...
Now, we will confirm if we have only those rows with study days from -7 to 27.
